...
#
# Generated by export_simulation on Wed Jul 11 08:31:29 +0800 2018
#
################################################################################
...
'-reset_run' switch to the './fmult.sh' script.
...
./fmult.sh -noclean_files

For more information on the script, please type './fmult.sh -help'.
